                        ...
                        <form onSubmit={e => onSubmit(e)} className="max-w-3xl mx-auto">
                            ...
                            <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-300 sm:pt-5">
                                ...
                                <div className="max-w-lg flex rounded-md shadow-sm">
                                    ...
                                    className="flex-1 block w-full focus:ring-indigo-800 focus:border-indigo-800 min-w-0 rounded-md sm:text-sm border-gray-800"
                                    />
                                </div>
                                </div>
                            </div>
                            ...
                            <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                                <label htmlFor="Ciudad" className="block text-sm font-medium text-gray-700 sm:mt-px sm:pt-2">
                                Ciudad: 
                                </label>
                                <div className="mt-1 sm:mt-0 sm:col-span-2">
                                <div className="max-w-lg flex rounded-md shadow-sm">
                            ...
                            <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                                ...
                                <select
                                    ...
                                    name='country_region'
                                    onChange={e => onChange(e)}
                                    className="max-w-lg block focus:ring-indigo-500 focus:border-indigo-500 w-full shadow-sm sm:max-w-xs sm:text-sm border-gray-800 rounded-md"
                                    >

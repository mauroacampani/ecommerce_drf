...
import { get_products_compare_price, get_filtered_products } from '../redux/actions/products';
      ...
      >
        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="relative z-10 flex items-baseline justify-between pt-24 pb-6 border-b border-gray-200">
            <h1 className="text-3xl font-bold tracking-tight text-gray-900">Productos en oferta</h1>

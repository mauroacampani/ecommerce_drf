...
from .views import ProductDetailView, ListProductsView, ListSearchView, ListBySearchView, ListRelatedView, ComparePriceView
...
urlpatterns = [
    ...
    path('compare-price', ComparePriceView.as_view()),
]
